---
title: Crowdstrike Roles Info
description: >
  Retrieves information on user roles within CrowdStrike, detailing permissions and access levels. This integration provides visibility into user privileges and access controls.
---

### Details
Monad uses the `cron` field to run this input on specific intervals and returns all user roles' info, performing a full sync of data each time.
## Prerequisites
...
### Related Articles
- [https://developer.crowdstrike.com/crowdstrike/reference/entitiesrolesv1-3](https://developer.crowdstrike.com/crowdstrike/reference/entitiesrolesv1-3)
- [https://developer.crowdstrike.com/crowdstrike/reference/queriesrolesv1-3](https://developer.crowdstrike.com/crowdstrike/reference/queriesrolesv1-3)
