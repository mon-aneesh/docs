---
title: Semgrep Supply Chain Findings
description: >
  Collects and processes Semgrep Supply Chain Findings from your Semgrep organization.
---
...
curl -X 'POST' \
  ...
  "name": "input_name",
  "promise_id": "",
  "type": "semgrep-supply-chain-findings"
}'
```
