---
title: Google Workspace Admin Activity Input
description: Collect Google Workspace Admin Activity logs from your Google Workspace Admin Activity API
---
...
The Google Workspace Admin Activity Input is configured using the following settings:
...
curl -X 'POST' \
 ...
 "name": "input_name",
 "promise_id": "",
 "type": "google-workspace-admin-activity"
}'
```
...
2. Periodically fetches admin activity logs.
3. Processes and publishes activity data to the pipeline for further handling.
...
- No data being fetched could indicate a lack of admin activities or logging issues in your Google Workspace.
