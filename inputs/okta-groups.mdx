...
title: Okta Groups
description: >
  Gathers user profile information from Okta, providing detailed records of user attributes, roles, and login activity.
---
...
## Prerequisites
- Before you connect Monad to Okta, you need an API token. API tokens are scoped to include all groups from a specific account in Okta.
