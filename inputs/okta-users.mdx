...
title: Okta Users
description: >
  Fetches user data from Okta API, providing a continuous stream of user information for monitoring and management purposes.
---
...
## Prerequisites
- Before you connect Monad to Okta, you need an API token. This connector also requires the okta.users.read OAuth2 Scope.
...
## Related Articles
- [https://developer.okta.com/docs/reference/api/users/](https://developer.okta.com/docs/reference/api/users/)
## Configuration
