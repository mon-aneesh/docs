---
title: Microsoft Azure Activity Logs
description: >
  Collects and ingests records from the Azure activity logs API.
---

## Details

The Microsoft Azure Activity Logs input allows you to collect and ingest activity logs from the Azure monitor API.
...
| Resource Group Name | string | false | The name of the resource group |
| Resource URI | string | false | The URI of the resource |
| Resource Provider | string | false | The provider of the resource |
| Correlation ID | string | false | The correlation ID of the log |
