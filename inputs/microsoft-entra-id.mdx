---
title: Entra Id (log analytics)
description: >
  Entra Id input allows you to query and ingest Entra Id logs from the Azure log analytics API.
---

## Details

 Entra Id input allows you to query and ingest logs from the Azure log analytics API.

## Prerequisites

Before setting up the Entra Id input you need to:
...
| Category | string | true | The category to of logs to get from the Log Analytics workspace |
